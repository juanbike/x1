...
@Component({
  ...
  standalone: true,
  imports: [ MatButtonModule, MatIconModule, MatFormFieldModule, ReactiveFormsModule, TextFieldModule, MatInputModule],
...
export class ModalagregarjuntaComponent    implements OnInit {
  ...
  @Output() miEventoAlPadre: EventEmitter<boolean> = new EventEmitter<boolean>();   // propiedad 'output'  para enviar datos al componente padre
